...
- **@rollup/plugin-typescript**: Official TypeScript integration for Rollup. Compiles package sources to the ES5 target while preserving the shared Rollup build and sourcemap pipeline.
